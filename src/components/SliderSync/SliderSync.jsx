  ...
  render() {
    ...
    return (
      <div>
        ...
        <img className="same1"  src="./Images/sony 3.1.jpg" alt="" width="115px" height="auto" />
        ...
        <img className="same1"  src="./Images/sony 2.1.jpg" alt="" width="115px" height="auto" />
        ...
        <img className="same1"  src="./Images/sony 4.4.jpg" alt="" width="115px" height="auto" />
        ...
        <img className="same1"  src="./Images/sony 1.1.jpg" alt="" width="115px" height="auto" />
